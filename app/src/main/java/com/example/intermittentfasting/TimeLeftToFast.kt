    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        object : CountDownTimer(input, 1000) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                val notification = NotificationCompat.Builder(this@TimeLeftToFast, timetrackingchannel)
            ...
            override fun onFinish() {
                stopSelf()
                val notint = Intent(this@TimeLeftToFast, MainActivity::class.java)
                val pedint =PendingIntent.getActivity(
                    this@TimeLeftToFast,
                    0, notint, 0
                )
                val notification = NotificationCompat.Builder(this@TimeLeftToFast, faststatuschannel)
                    .setSmallIcon(R.drawable.ic_restaurant_black_24dp)
                    .setContentTitle("Intermittent Fasting")
